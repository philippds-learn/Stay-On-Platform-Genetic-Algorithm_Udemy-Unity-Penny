...
public class PopulationManager : MonoBehaviour
{
    ...
    void BreedNewPopulation()
    {
        ...
        // walking being the best fitness
        // List<GameObject> sortedList = this.population.OrderBy(o => o.GetComponent<Brain>().timeWalking).ToList();
        // walking and being alive as the best fitness - bias towards walking: 5
        List<GameObject> sortedList = this.population.OrderBy(o => (o.GetComponent<Brain>().timeAlive +
